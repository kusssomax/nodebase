import { Loader2Icon, MoreVerticalIcon, PackageOpenIcon, PlusIcon, Trash2Icon } from "lucide-react";
...
export const EmptyView = ({ message, onNew }: EntityViewProps) => {
  return (
...
export const EntityItem = ({ href, title, subtitle, image, actions, onRemove, isRemoving, className="" }: EntityItemProps) => {
  ...
  return (
    <Link href={href} prefetch>
      <Card className={cn("shadow-none p-4 hover:shadow cursor-pointer", isRemoving && "opacity-50 cursor-not-allowed", className)}>
