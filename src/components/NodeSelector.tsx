...
const triggerNodes: NodeTypeOption[] = [
    {
        ...
        description: "Trigger the workflow manually by clicking a button",
...
const executionNodes: NodeTypeOption[] = [
    {
        ...
        label: "HTTP Request",
        description: "Trigger the workflow by making an HTTP request",
        icon: GlobeIcon,
    },
];
...
export const NodeSelector = ({ open, onOpenChange, children }: NodeSelectorProps) => {
    ...
    }, [setNodes, screenToFlowPosition, onOpenChange, getNodes])
                ...
                <div>
                    {triggerNodes.map((nodeType) => {
                        ...
                        return (
                            ...
                            className="w-full h-auto py-5 px-4 justify-start rounded-none cursor-pointer border-l-2 border-transparent
